...
def add_text_generate_args(parser):
    ...
    group.add_argument(
        "--context-tokens", type=str, default="What is the language spoken in Mexico ?"
    )
    group.add_argument("--max-tokens", type=int, default=30)
...
if __name__ == "__main__":
    ...
    # setup model wrap with deepspeed
    ...
    # Set up prompts
    #prompts=["An arithmetic sequence is", "Pythagoras theorem is defined", "Define mass", "Hello world"] # modify to give your list of prompts
    prompts=["What is the language spoken in Mexico?"] # modify to give your list of prompts
